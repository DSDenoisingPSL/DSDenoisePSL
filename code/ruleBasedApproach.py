...
if __name__ == "__main__":
	if len(sys.argv) != 5:
		print 'Usage: ruleBasedApproach.py -DATA (KBP/NYT/Google) -DIR (test/train) -FILENAME -RULESET'
		exit(-1)
	...
	bruteForceApproach(indir+'/brute_force.json',psl_dir,psl_dir+'/candidate_rm.json')
